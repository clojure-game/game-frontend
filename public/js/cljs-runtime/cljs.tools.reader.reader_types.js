...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_37914 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_37914(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_37916 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_37916(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37925 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37925(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37931 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37931(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37941 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37941(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37958 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37958(reader);
}
});
...
var G__38088 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__38089 = s.append(c);
c = G__38088;
s = G__38089;
continue;
}
