...
var len__5769__auto___30325 = arguments.length;
var i__5770__auto___30326 = (0);
while(true){
if((i__5770__auto___30326 < len__5769__auto___30325)){
args__5775__auto__.push((arguments[i__5770__auto___30326]));

var G__30329 = (i__5770__auto___30326 + (1));
i__5770__auto___30326 = G__30329;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__30252_30330 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30253_30331 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30254_30332 = true;
var _STAR_print_fn_STAR__temp_val__30255_30333 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30254_30332);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30255_30333);

try{var _STAR_print_level_STAR__orig_val__30256_30334 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30257_30335 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30257_30335);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30256_30334);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30253_30331);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30252_30330);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30250){
...
var new_formatters = current_formatters.filter((function (p1__30273_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30273_SHARP_)));
}));
...
var G__30274_30363 = f;
var target__27789__auto___30364 = G__30274_30363;
if(cljs.core.truth_(target__27789__auto___30364)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30274_30363)].join(''),"\n","target__27789__auto__"].join('')));
}

(target__27789__auto___30364["toString"] = (function (){
...
var G__30281_30370 = "%c%s";
var G__30282_30371 = "color:transparent";
var G__30283_30372 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30281_30370,G__30282_30371,G__30283_30372) : f.call(null,G__30281_30370,G__30282_30371,G__30283_30372));
...
var G__30378 = (i__5770__auto___30375 + (1));
i__5770__auto___30375 = G__30378;
continue;
} else {
}
break;
...
var vec__30292 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30292,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30292,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30379__delegate = function (add_fmt,add_args){
...
var G__30379 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__30380__i = 0, G__30380__a = new Array(arguments.length -  1);
while (G__30380__i < G__30380__a.length) {G__30380__a[G__30380__i] = arguments[G__30380__i + 1]; ++G__30380__i;}
  add_args = new cljs.core.IndexedSeq(G__30380__a,0,null);
} 
return G__30379__delegate.call(this,add_fmt,add_args);};
G__30379.cljs$lang$maxFixedArity = 1;
G__30379.cljs$lang$applyTo = (function (arglist__30381){
var add_fmt = cljs.core.first(arglist__30381);
var add_args = cljs.core.rest(arglist__30381);
return G__30379__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30284){
var G__30285 = cljs.core.first(seq30284);
var seq30284__$1 = cljs.core.next(seq30284);
var G__30286 = cljs.core.first(seq30284__$1);
var seq30284__$2 = cljs.core.next(seq30284__$1);
var G__30287 = cljs.core.first(seq30284__$2);
var seq30284__$3 = cljs.core.next(seq30284__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30285,G__30286,G__30287,seq30284__$3);
}));
...
var seq__30296 = cljs.core.seq(features);
var chunk__30297 = null;
var count__30298 = (0);
var i__30299 = (0);
while(true){
if((i__30299 < count__30298)){
var feature = chunk__30297.cljs$core$IIndexed$_nth$arity$2(null,i__30299);
...
var G__30389 = seq__30296;
var G__30390 = chunk__30297;
var G__30391 = count__30298;
var G__30392 = (i__30299 + (1));
seq__30296 = G__30389;
chunk__30297 = G__30390;
count__30298 = G__30391;
i__30299 = G__30392;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__30296);
if(temp__5804__auto__){
var seq__30296__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30296__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__30296__$1);
var G__30393 = cljs.core.chunk_rest(seq__30296__$1);
var G__30394 = c__5568__auto__;
var G__30395 = cljs.core.count(c__5568__auto__);
var G__30396 = (0);
seq__30296 = G__30393;
chunk__30297 = G__30394;
count__30298 = G__30395;
i__30299 = G__30396;
continue;
} else {
var feature = cljs.core.first(seq__30296__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30398 = cljs.core.next(seq__30296__$1);
var G__30399 = null;
var G__30400 = (0);
var G__30401 = (0);
seq__30296 = G__30398;
chunk__30297 = G__30399;
count__30298 = G__30400;
i__30299 = G__30401;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o30317 = temp__5802__auto__;
return (o30317["version"]);
} else {
return null;
}
})() == null);
