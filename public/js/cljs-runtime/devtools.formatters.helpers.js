...
var G__28947 = devtools.prefs.pref(v);
v = G__28947;
continue;
} else {
return v;
...
}catch (e28897){var _e__27799__auto__ = e28897;
return false;
}})();
...
}catch (e28900){var _e__27799__auto__ = e28900;
return false;
}})();
...
}catch (e28905){var _e__27799__auto__ = e28905;
return false;
}}
}
});
...
var vec__28917 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28917,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28917,(1),null);
...
return cljs.core.some((function (p1__28930_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28930_SHARP_);
}),template);
});
