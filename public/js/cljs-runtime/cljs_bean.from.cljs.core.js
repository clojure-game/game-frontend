...
var G__38782 = cljs.core.next(xs);
var G__38783 = cljs.core.next(ys);
xs = G__38782;
ys = G__38783;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__38683 = val;
var G__38684 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__38683,G__38684) : f.call(null,G__38683,G__38684));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__38693 = val__$1;
var G__38694 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__38693,G__38694) : f.call(null,G__38693,G__38694));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__38698 = val__$1;
var G__38699 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__38698,G__38699) : f.call(null,G__38698,G__38699));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__38803 = cljs.core.next(es);
var G__38804 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__38803;
tcoll__$1 = G__38804;
continue;
} else {
...
var G__38805 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__38806 = cljs.core.next(es);
ret = G__38805;
es = G__38806;
continue;
} else {
