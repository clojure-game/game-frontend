...
var len__5769__auto___28804 = arguments.length;
var i__5770__auto___28805 = (0);
while(true){
if((i__5770__auto___28805 < len__5769__auto___28804)){
args__5775__auto__.push((arguments[i__5770__auto___28805]));

var G__28806 = (i__5770__auto___28805 + (1));
i__5770__auto___28805 = G__28806;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq28746){
var G__28747 = cljs.core.first(seq28746);
var seq28746__$1 = cljs.core.next(seq28746);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28747,seq28746__$1);
}));
...
return cljs.core.some((function (p1__28760_SHARP_){
return (p1__28760_SHARP_ === object);
}),history__$1);
});
...
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.map_QMARK_(history);
...
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.map_QMARK_(parent_object);
if(and__5043__auto__){
...
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.map_QMARK_(devtools.formatters.state.get_second_last_object_from_current_history());
if(and__5043__auto__){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = path_info;
