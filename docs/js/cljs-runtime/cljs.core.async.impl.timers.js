...
var i_33379 = (0);
while(true){
if((i_33379 < arr.length)){
(arr[i_33379] = null);

var G__33380 = (i_33379 + (1));
i_33379 = G__33380;
continue;
} else {
}
...
var i_33394 = (self__.level + (1));
while(true){
if((i_33394 <= (new_level + (1)))){
(update[i_33394] = self__.header);

var G__33396 = (i_33394 + (1));
i_33394 = G__33396;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33397 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33397[i]));
} else {
x__$2.forward.push((((i < links_33397.length))?(links_33397[i]):null));
}

if((i < links_33397.length)){
(links_33397[i] = x__$2);
} else {
links_33397.push(x__$2);
}
...
var i_33399 = (0);
while(true){
if((i_33399 <= self__.level)){
var links_33404 = (update[i_33399]).forward;
if((x__$1 === (((i_33399 < links_33404.length))?(links_33404[i_33399]):null))){
(links_33404[i_33399] = (x__$1.forward[i_33399]));

var G__33405 = (i_33399 + (1));
i_33399 = G__33405;
continue;
} else {
var G__33406 = (i_33399 + (1));
i_33399 = G__33406;
continue;
}
} else {
...
var G__33408 = nx;
var G__33409 = (level__$1 - (1));
x = G__33408;
level__$1 = G__33409;
continue;
} else {
var G__33410 = x;
var G__33411 = (level__$1 - (1));
x = G__33410;
level__$1 = G__33411;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33413 = nx;
var G__33414 = (level__$1 - (1));
x = G__33413;
level__$1 = G__33414;
continue;
} else {
var G__33415 = x;
var G__33416 = (level__$1 - (1));
x = G__33415;
level__$1 = G__33416;
continue;
}
