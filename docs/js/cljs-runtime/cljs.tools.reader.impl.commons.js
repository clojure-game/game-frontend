...
var G__38247 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__38247;
continue;
} else {
return ch;
...
var vec__38237 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38237,(0),null);
return (match === s);
});
...
while(true){
if((i__5770__auto___38250 < len__5769__auto___38248)){
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq38242){
var G__38243 = cljs.core.first(seq38242);
var seq38242__$1 = cljs.core.next(seq38242);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38243,seq38242__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__38253__delegate = function (rdr,_){
...
var G__38253 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__38254__i = 0, G__38254__a = new Array(arguments.length -  1);
while (G__38254__i < G__38254__a.length) {G__38254__a[G__38254__i] = arguments[G__38254__i + 1]; ++G__38254__i;}
  _ = new cljs.core.IndexedSeq(G__38254__a,0,null);
} 
return G__38253__delegate.call(this,rdr,_);};
G__38253.cljs$lang$maxFixedArity = 1;
G__38253.cljs$lang$applyTo = (function (arglist__38255){
var rdr = cljs.core.first(arglist__38255);
var _ = cljs.core.rest(arglist__38255);
return G__38253__delegate(rdr,_);
});
