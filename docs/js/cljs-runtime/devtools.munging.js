...
var o28563 = temp__5802__auto__;
var temp__5802__auto____$1 = (o28563["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o28564 = temp__5802__auto____$1;
return (o28564["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27772__auto__ = f;
return (o__27772__auto__["toString"]).call(o__27772__auto__);
} else {
return "";
}
}catch (e28565){var _ = e28565;
return "";
}});
...
try{var o__27772__auto___28882 = t;
(o__27772__auto___28882["cljs$lang$ctorPrWriter"]).call(o__27772__auto___28882,t,writer);
}catch (e28571){var __28884 = e28571;
}
...
var char_code = (function (){var o__27772__auto__ = (new String(char$));
return (o__27772__auto__["charCodeAt"]).call(o__27772__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27772__auto__ = String;
return (o__27772__auto__["fromCharCode"]).call(o__27772__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28578 = num_code;
switch (G__28578) {
case (1):
return (185);
...
var o__27772__auto__ = String;
return (o__27772__auto__["fromCharCode"]).call(o__27772__auto__,superscript_code);
});
/**
...
}catch (e28581){var _e__27799__auto__ = e28581;
return false;
}})())){
...
var vec__28585 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28585,(0),null);
...
var len__5769__auto___28907 = arguments.length;
var i__5770__auto___28908 = (0);
while(true){
if((i__5770__auto___28908 < len__5769__auto___28907)){
args__5775__auto__.push((arguments[i__5770__auto___28908]));

var G__28911 = (i__5770__auto___28908 + (1));
i__5770__auto___28908 = G__28911;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28614){
var vec__28615 = p__28614;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28615,(0),null);
...
var G__28913 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28914 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28913;
remaining_tokens = G__28914;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28607){
var G__28609 = cljs.core.first(seq28607);
var seq28607__$1 = cljs.core.next(seq28607);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28609,seq28607__$1);
}));
...
var vec__28622 = cljs.core.split_with((function (p1__28621_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28621_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28622,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28622,(1),null);
...
var vec__28629 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28629,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28629,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28920 = cljs.core.rest(remaining_tokens);
var G__28921 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28920;
name_tokens = G__28921;
continue;
} else {
...
var vec__28641 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28641,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28641,(1),null);
var vec__28644 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28644,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28644,(1),null);
var vec__28647 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(3),null);
...
var vec__28696 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28696,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__28706 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28706,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28706,(1),null);
var vec__28709 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28709,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28709,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28729 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28729) : devtools.munging.parse_fn_info_deep.call(null,G__28729));
})()));
}
} else {
return fn_info;
...
var G__28953 = (arity + (1));
var G__28954 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28748){
var vec__28749 = p__28748;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28749,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28749,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28767_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28767_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28771_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28771_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___28958 = arguments.length;
var i__5770__auto___28959 = (0);
while(true){
if((i__5770__auto___28959 < len__5769__auto___28958)){
args__5775__auto__.push((arguments[i__5770__auto___28959]));

var G__28960 = (i__5770__auto___28959 + (1));
i__5770__auto___28959 = G__28960;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28778){
var vec__28779 = p__28778;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28779,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28776){
var G__28777 = cljs.core.first(seq28776);
var seq28776__$1 = cljs.core.next(seq28776);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28777,seq28776__$1);
}));
...
var map__28808 = options;
var map__28808__$1 = cljs.core.__destructure_map(map__28808);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28808__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28808__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28808__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28808__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28809 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28809,(5),null);
...
var o__27772__auto__ = f;
return (o__27772__auto__["getBasis"]).call(o__27772__auto__);
});
/**
...
}catch (e28820){var _e__27799__auto__ = e28820;
...
var G__28966 = (obj[cljs.core.first(path)]);
var G__28967 = cljs.core.rest(path);
obj = G__28966;
path = G__28967;
continue;
} else {
...
var _STAR_ = (function (accum,p__28834){
var vec__28835 = p__28834;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28835,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28847){
var vec__28849 = p__28847;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28849,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28849,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28849,(2),null);
...
var post_process = (function (p__28858){
var vec__28859 = p__28858;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28859,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28859,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28857_SHARP_){
return (obj[cljs.core.first(p1__28857_SHARP_)]);
}),sorted_matches);
